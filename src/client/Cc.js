...
const languageMode = ["java", "python", "javascript", "typescript ","angular"];
...
class Cc extends React.Component {
  ...
  handleDropDownValueChange = (e) => {
    ...
    else if (document.getElementById("langA").value === "5")
      document.getElementById("langB").value = "5";  
  ...
  apiRequest = async (inputValue) => {
    ...
    const question4 = "# Convertion from Vue to Reac component t\n[ Vue code ]\n";
    const answer4 = "\n# End\n[ React code ]\n";

    const question5 = "# Convertion from Angular to React\n[ Angular code ]\n";
    const answer5 = "\n# End\n[ React code ]\n";

    const question6 = "# Convertion from React to Angular\n[ Reac code ]\n";
    const answer6 = "\n# End\n[ Angular code ]\n";
    const url =
    ...
    }else if (this.state.dropDownVal === "5") {
        promptValue = `${question5}${inputValue}${answer5}`;
    }else if (this.state.dropDownVal === "6") {
        promptValue = `${question6}${inputValue}${answer6}`;
    } else {
      promptValue = null;
    }
    const params = {
