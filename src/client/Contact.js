...
import { Badge,Button,Container,Row,Card,Col } from "react-bootstrap";
...
const Contact = () => {
  return (
    <div>
      ...
      ></div> 
      <div
        class="u-border-1 u-border-grey-10 u-container-style u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-grey-5 u-group u-shape-rectangle u-group-1"
      ...
      ></div>*/}
        ...
        <div class="u-container-layout u-container-layout-1">
          ...
          <Row>
              <Col>
              <h3
                style={{ fontSize: '45px', margin: 0, top: '14px', left: '14px' }}
              >
                Contact Info
              </h3>
              <a
                class="u-active-none u-btn u-button-style u-hover-none u-none u-text-hover-palette-1-base u-btn-2"
              ...
              <a
                ...
                class="u-active-none u-btn u-button-style u-hover-none u-none u-text-hover-palette-1-base u-btn-3"
                ><span class="u-icon u-text-palette-1-base u-icon-2"
                  ...
                  >
                    ...
                    ></path></svg
                  ><img /></span
                >&nbsp;19dx01@psgpolytech.ac.in
              </a>
              </Col>
            <Col><div class="u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
            <form
              action="#"
              method="POST"
            ...
            >
              <div class="u-form-group u-form-name">
                ...
                <input
                  ...
                  id="name-da97"
                  name="name"
                  class="u-border-1 u-border-grey-25 u-input u-input-rectangle u-radius-12 u-white"
                  required=""
                />
              </div>
              ...
              <div class="u-form-group u-form-message">
                <label for="message-da97" class="u-form-control-hidden u-label"
                  >Message</label
                >
                <textarea
              ...
              <div class="u-align-center u-form-group u-form-submit">
                <a
                  href="#"
                  class="u-active-palette-1-light-3 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-white u-radius-12 u-text-active-palette-1-base u-white u-btn-1"
                  style={{ marginTop: 0 }}
                  >SUBMIT</a
                >
                <input
          ...
          <div class="u-social-icons u-spacing-16 u-social-icons-1">
            <a
              ...
              href=""
              ><span
                class="u-icon u-icon-circle u-social-custom u-social-icon u-text-palette-1-base u-icon-3"
                ><svg
                  class="u-svg-link"
                ...
                ><svg class="u-svg-content" viewBox="0 0 512 512" id="svg-7180">
                  <path
            ...
            <a
              ...
              href=""
              ><span
                class="u-icon u-icon-circle u-social-custom u-social-icon u-text-palette-1-base u-icon-4"
                ><svg
                  class="u-svg-link"
                  preserveAspectRatio="xMidYMin slice"
            ...
            <a
              ...
              href=""
              ><span
                class="u-icon u-icon-circle u-social-custom u-social-icon u-text-palette-1-base u-icon-5"
                ><svg
                  class="u-svg-link"
                  preserveAspectRatio="xMidYMin slice"
            ...
            <a
              ...
              href=""
              ><span
                class="u-icon u-icon-circle u-social-custom u-social-icon u-text-palette-1-base u-icon-6"
                ><svg
                  class="u-svg-link"
                  preserveAspectRatio="xMidYMin slice"
